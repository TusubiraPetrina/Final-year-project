...
def FarmerBasicView(request):
    ...
    if request.method == 'GET':
        ...
        return Response({'data': serializer.data, 'count': paginator.count, 'numpages': paginator.num_pages, 'nextlink': '/api/farmers/?page=' + str(nextPage), 'prevlink': '/api/farmers/?page=' + str(previousPage)})
...
def PreciBasicView(request):
    ...
    if request.method == 'GET':
        ...
        serializer = PrecipitationSerializer(data, context={'request' : request}, many=True)
        ...
        return Response({'data': serializer.data, 'count': paginator.count, 'numpages': paginator.num_pages, 'nextlink': '/api/precipitation/?page=' + str(nextPage), 'prevlink': '/api/precipitation/?page=' + str(previousPage)})
...
def PreciDetailView(request, id):
    ...
    if request.method == 'GET':
        ...
        serializer = PrecipitationSerializer(preci_record, data = request.data, context = {'request': request})
...
def MaizeBasicView(request):
    ...
    if request.method == 'GET':
        ...
        return Response({'data': serializer.data, 'count': paginator.count, 'numpages': paginator.num_pages, 'nextlink': '/api/crop/?page=' + str(nextPage), 'prevlink': '/api/crop/?page=' + str(previousPage)})
...
def MaizeDetailView(request, type):
    ...
    if request.method == 'GET':
        ...
        serializer = PrecipitationSerializer(crop_record, data = request.data, context = {'request': request})
